        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="font-body text-dust leading-relaxed mb-6" style={{ fontWeight: 300, fontSize: '1.05rem' }}>
              С 2009 года «МАСТЕР ВУД» специализируется на распиловке и строгании древесины. Начав с небольшой пилорамы, сегодня мы — современное производство полного цикла с собственным парком оборудования и командой профессионалов.
            </p>
