...
const services = [
  ...
  { icon: 'Ruler', title: 'Сушка пиломатериалов', desc: 'Камерная сушка до требуемой влажности. Равномерный процесс без трещин и деформаций.' },
  ...
  { icon: 'Zap', title: 'ЧПУ-фрезерование', desc: 'Сложные фигурные элементы по чертежам заказчика. Точность до 0.1 мм на изделие любой сложности.' },
  { icon: 'Package', title: 'Склейка и ламелирование', desc: 'Клееный брус и щиты из ламелей. Прочность выше массива, стабильность геометрии.' },
